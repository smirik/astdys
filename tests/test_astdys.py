...
def test_multiple_catalogs():
    ...
    assert 54.070272 == pytest.approx(obj["g"], 0.01)
    assert -59.170034 == pytest.approx(obj["s"], 0.01)
    assert 1.16 == pytest.approx(obj["lce"], 0.01)
    assert -2 == pytest.approx(obj["my"], 0.01)
